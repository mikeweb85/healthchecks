...
<body>
	<h2>DFS Monitoring on <%= HostName %></h2>
...
<% if (BiDirectional == true) { %>
	<br /><br />
	<h3>Checking DFS Bi-Directional Status<br /><small>Maximum time differential of <%= ReplicationAllowMinutes %> minute(s)</small></h3>
	<ul>
	<%
...
<% } %>
	...
	<br /><br />
	<h3>DFS Overall Status</h3>
<% if (SyncErrors == 0) { %>
	<p><strong>Success:</strong> DFS running.</p>
<% } else { %>
	<p><strong>Error:</strong> DFS has <%= SyncErrors %> alert(s).</p>
<% } %>
</body>
</html>